...
// TODO, Nov 9, 2021: 
// merged nonfilled/filled, add bool for filled
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
#include <string.h>
/* Use intrinsic lrint for VS2019 */
#include <emmintrin.h>
...
int lineRGBA(SDL_Renderer * renderer, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	...
	*/
	...
	result |= SDL_SetRenderDrawColor(renderer, 0, 0, 0, SDL_ALPHA_OPAQUE);
...
\returns Returns 0 on success, -1 on failure.
*/
int circleColor(SDL_Renderer * renderer, Sint16 x, Sint16 y, Uint16 rad, Uint32 color)
{
	Uint8 *c = (Uint8 *)&color; 
...
\returns Returns 0 on success, -1 on failure.
*/
int circleRGBA(SDL_Renderer * renderer, Sint16 x, Sint16 y, Uint16 rad, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
...
\returns Returns 0 on success, -1 on failure.
*/
int arcColor(SDL_Renderer * renderer, Sint16 x, Sint16 y, Uint16 rad, Sint16 start, Sint16 end, Uint32 color)
{
	Uint8 *c = (Uint8 *)&color; 
...
int arcRGBA(SDL_Renderer * renderer, Sint16 x, Sint16 y, Uint16 rad, Sint16 start, Sint16 end, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	int result;
	Sint16 cx = 0;
	Sint16 cy = rad;
...
\returns Returns 0 on success, -1 on failure.
*/
int aacircleColor(SDL_Renderer * renderer, Sint16 x, Sint16 y, Uint16 rad, Uint32 color)
{
	Uint8 *c = (Uint8 *)&color; 
...
\returns Returns 0 on success, -1 on failure.
*/
int aacircleRGBA(SDL_Renderer * renderer, Sint16 x, Sint16 y, Uint16 rad, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	/*
	* Draw 
	*/
...
int _ellipseRGBA(SDL_Renderer * renderer, Sint16 x, Sint16 y, Uint16 rx, Uint16 ry, Uint8 r, Uint8 g, Uint8 b, Uint8 a, Sint32 f)
{
	int result;
	Sint32 rxi, ryi;
...
\returns Returns 0 on success, -1 on failure.
*/
int ellipseColor(SDL_Renderer * renderer, Sint16 x, Sint16 y, Uint16 rx, Uint16 ry, Uint32 color)
{
	Uint8 *c = (Uint8 *)&color; 
...
\returns Returns 0 on success, -1 on failure.
*/
int ellipseRGBA(SDL_Renderer * renderer, Sint16 x, Sint16 y, Uint16 rx, Uint16 ry, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	return _ellipseRGBA(renderer, x, y, rx, ry, r, g, b, a, 0);
}


int ellipseTextureRGBA(SDL_Renderer* renderer, SDL_Texture* texture, Sint16 x, Sint16 y, Uint16 rx, Uint16 ry, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	int result = SDL_SetRenderTarget(renderer, texture);
	result = _ellipseRGBA(renderer, x, y, rx, ry, r, g, b, a, 0); 
...
\returns Returns 0 on success, -1 on failure.
*/
int filledCircleColor(SDL_Renderer * renderer, Sint16 x, Sint16 y, Uint16 rad, Uint32 color)
{
	Uint8 *c = (Uint8 *)&color; 
...
\returns Returns 0 on success, -1 on failure.
*/
int filledCircleRGBA(SDL_Renderer * renderer, Sint16 x, Sint16 y, Uint16 rad, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
...
\returns Returns 0 on success, -1 on failure.
*/
int aaellipseColor(SDL_Renderer * renderer, Sint16 x, Sint16 y, Uint16 rx, Uint16 ry, Uint32 color)
{
	Uint8 *c = (Uint8 *)&color; 
...
\returns Returns 0 on success, -1 on failure.
*/
int aaellipseRGBA(SDL_Renderer * renderer, Sint16 x, Sint16 y, Uint16 rx, Uint16 ry, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	int result;
	int i;
...
\returns Returns 0 on success, -1 on failure.
*/
int filledEllipseColor(SDL_Renderer * renderer, Sint16 x, Sint16 y, Uint16 rx, Uint16 ry, Uint32 color)
{
	Uint8 *c = (Uint8 *)&color; 
...
\returns Returns 0 on success, -1 on failure.
*/
int filledEllipseRGBA(SDL_Renderer * renderer, Sint16 x, Sint16 y, Uint16 rx, Uint16 ry, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
...
int _pieRGBA(SDL_Renderer * renderer, Sint16 x, Sint16 y, Uint16 rad, Sint16 start, Sint16 end,  Uint8 r, Uint8 g, Uint8 b, Uint8 a, Uint8 filled)
{
	int result;
...
\returns Returns 0 on success, -1 on failure.
*/
int pieColor(SDL_Renderer * renderer, Sint16 x, Sint16 y, Uint16 rad, 
...
\returns Returns 0 on success, -1 on failure.
*/
int pieRGBA(SDL_Renderer * renderer, Sint16 x, Sint16 y, Uint16 rad,
...
\returns Returns 0 on success, -1 on failure.
*/
int filledPieColor(SDL_Renderer * renderer, Sint16 x, Sint16 y, Uint16 rad, Sint16 start, Sint16 end, Uint32 color)
{
	Uint8 *c = (Uint8 *)&color; 
...
\returns Returns 0 on success, -1 on failure.
*/
int filledPieRGBA(SDL_Renderer * renderer, Sint16 x, Sint16 y, Uint16 rad,
	Sint16 start, Sint16 end, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
...
\returns Returns 0 on success, -1 on failure.
*/
int thickLineColor(SDL_Renderer *renderer, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Uint16 width, Uint32 color, SDL_bool antiAliased)
{	
	Uint8 *c = (Uint8 *)&color; 
	return thickLineRGBA(renderer, x1, y1, x2, y2, width, c[0], c[1], c[2], c[3], antiAliased);
}
...
\returns Returns 0 on success, -1 on failure.
*/	
int thickLineRGBA(SDL_Renderer *renderer, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Uint16 width, Uint8 r, Uint8 g, Uint8 b, Uint8 a, SDL_bool antiAliased)
{
	int wh;
	...
	if (width == 1)
	{
		if (!antiAliased) /* Use the anti-aliased call */
		{
			return lineRGBA(renderer, x1, y1, x2, y2, r, g, b, a);
		}
		else
		{
			return aalineRGBA(renderer, x1, y1, x2, y2, r, g, b, a);
		}
	}
